...
<div class=" flex flex-col gap-6 mt-20">
    ...
    <div class="font-bold flex px-8 text-gray-700">General</div>
        ...
        <div class="flex items-center px-6 py-4 rounded-full transition bg-gray-100 hover:bg-gray-300 w-60 ml-6 cursor-pointer" onClick="window.location.href='dashboard'">
